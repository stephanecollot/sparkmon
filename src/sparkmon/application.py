...
class Application():
    ...
    def get_executors_info(self) -> Dict[Any, Any]:
        ...
        executors_df = pd.read_json(urlpath.URL(self.spark_session_link, API_APPLICATIONS_LINK, self.application_id, 'executors'))
        return executors_df
    ...
    def parse_executors(executors_df: pd.DataFrame) -> Dict[Any, Any]:
        ...
        executors_df['usedOnHeapStorageMemoryPct'] = executors_df['usedOnHeapStorageMemory'] / executors_df['totalOnHeapStorageMemory'] *100
        executors_df['usedOffHeapStorageMemoryPct'] = executors_df['usedOffHeapStorageMemory'] / executors_df['totalOffHeapStorageMemory'] *100
...
def get_application_ids(spark_session_link=SPARK_SESSION_LINK) -> pd.DataFrame:
    ...
    applications_df = pd.read_json(urlpath.URL(spark_session_link, API_APPLICATIONS_LINK))
    return applications_df


def create_application_from_link(id=0, spark_session_link=SPARK_SESSION_LINK) -> Application:
